  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setPortfolios(Array.isArray(portfoliosData.results) ? portfoliosData.results.slice(0, 4) : []);
    ...
    <aside className="rbs-widget-area">
      ...
      <div className="rbs-card">
        <h3 className="rbs-card-title">
          <i className="fas fa-clock"></i> {t("Recent Portfolio")}
        </h3>
        ...
        {loading ? (
          ...
          <div className="rbs-recent-list">
            {portfolios.map((portfolio) => (
              <Link href={`/portfolio/details/${portfolio.slug}`} className="rbs-recent-item" key={portfolio.slug}>
                <div className="rbs-recent-thumb">
                  <Image
                    src={portfolio.image_cover_url || "/images/default-cover.jpg"}
                    alt={portfolio.title}
                    fill
                ...
                <div className="rbs-recent-info">
                  <span className="rbs-recent-date">{formatDate(portfolio.project_date)}</span>
          ...
          <p className="rbs-empty-text">{t("No recent portfolio found")}</p>
        )}
      </div>
