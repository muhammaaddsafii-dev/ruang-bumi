        ...
        <div className="container">
          <div className="services-details-overview">
            <div className="services-details-desc">
              <h3>{t("Gis And Mapping Services")}</h3>
              ...
              <div className="features-text">
                <h4>
                  <i className="flaticon-tick"></i> {t("GIS App & GeoAI")}
                </h4>
                <p>
                  {t("WebGIS, GIS Processing and Analyst, Tree Palm Counting, Object Detection and Classification")}
                </p>
              </div>
            </div>
